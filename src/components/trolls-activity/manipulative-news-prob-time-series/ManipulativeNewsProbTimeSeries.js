...
export default class ManipulativeNewsProbTimeSeries extends React.Component {
  componentDidMount() {
    this.setChart();
  };
  ...
  setChart() {
    this.chart = am4core.create("ManipulativeNewsProbTimeSeries", am4charts.XYChart);
    ...
    this.series.fill = am4core.color("#d0001c");
    this.series.stroke = am4core.color("#d0001c");
    ...
    this.chart.legend.labels.template.text = "Fake News Probability, %";
  ...
  render() {
    return (
      <div className='ManipulativeNewsProbTimeSeriesContainer'>
        <div id="ManipulativeNewsProbTimeSeries"/>
      </div>
    );
  }
}
