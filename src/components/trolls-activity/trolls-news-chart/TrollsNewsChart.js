...
export default class TrollsNewsChart extends React.Component {

  componentDidMount() {
    this.chart = am4core.create("trollsNewsChart", am4charts.PieChart);
  ...
  render() {
    return (<div className="trollsNewsChart" />);
  }
}
